...
<body>
    ...
    <div class="container user-wrapper">
        <div class="user-nav row">
            ...
            <a href="/authentication/register" class="active">Đăng Ký</a>
        </div>
        <form class="m-3" method="post" id="registerForm" action="#">
            ...
            <button type="submit" class="btn btn-outline-violet backgound-violet text-white btn-block">Đăng ký</button>
          </form>
    </div>
    <?php
